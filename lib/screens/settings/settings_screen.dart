        ...
        children: [
          ...
          GlowCard(
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              const SizedBox(height: 10),
              Wrap(spacing: 8, runSpacing: 8, children: fonts.map((f) => ChoiceChip(label: Text(f), selected: settings.fontFamily == f, onSelected: (_) => notifier.setSettings(settings.copyWith(fontFamily: f))).toList()),
            ]),
          ),
          const SizedBox(height: 12),
          GlowCard(
